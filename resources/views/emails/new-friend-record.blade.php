...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="images/image-4.png" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 27%;max-width: 143.1px;" width="143.1" class="v-src-width v-src-max-width"/>
      </a>
    </td>
  </tr>
</table>
...
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">You have added a new record.</span></p>
<p style="font-size: 14px; line-height: 140%;">&nbsp;</p>

    <ul>
        <li>Name: {{ $friend_name }}</li>
        <li>Email: {{ $friend_email }}</li>
        <li>Contact Number: {{ $friend_contact_number }}</li>
    </ul>
